"""
Domain Management Service - Flask Application Factory
...
def register_middleware(app: Flask) -> None:
    ...
    def add_security_headers(response):
        ...
        response.headers['X-Service'] = app.config.get('SERVICE_NAME', 'domain-management-service')
...
def setup_app_logging(app: Flask) -> None:
    ...
    if not app.debug and not app.testing:
        ...
        file_handler = RotatingFileHandler(
            'logs/domain-management-service.log',
        ...
        app.logger.info(f'Domain Management Service startup')
