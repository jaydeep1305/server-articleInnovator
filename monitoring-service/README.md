...
The Monitoring Service is a microservice that handles system monitoring and health checks. It's part of an event-driven architecture using Flask, PostgreSQL, and RabbitMQ.
...
- **ServiceHealth**: [Description needed]
- **Metric**: [Description needed]
...
docker build -t monitoring-service:latest --target production .
...
### Logging
- Logs are written to `logs/monitoring-service.log`
