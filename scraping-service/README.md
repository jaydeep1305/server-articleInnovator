...
External data scraping service

## Overview

The Scraping Service is a microservice that handles external data scraping service. It's part of an event-driven architecture using Flask, PostgreSQL, and RabbitMQ.
...
- **ScrapingJob**: [Description needed]
- **ScrapedData**: [Description needed]
...
docker build -t scraping-service:latest --target production .
...
### Logging
- Logs are written to `logs/scraping-service.log`
