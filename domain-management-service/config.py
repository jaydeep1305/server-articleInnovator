"""
Configuration module for Domain Management Service.

This module provides environment-specific configuration classes that handle
manages domains and wordpress integration, database connections, event bus configuration,
...
class EventBusConfig:
    ...
    password: str
    virtual_host: str = "/"
    exchange_name: str = "domain_management_service_events"
...
class BaseConfig:
    """Base configuration class for Domain Management Service."""
    
    # Flask Settings
    SECRET_KEY: str = os.environ.get('SECRET_KEY', 'dev-domain-management-service-secret-key')
    DEBUG: bool = False
    TESTING: bool = False
    ...
    SERVICE_NAME: str = "domain-management-service"
    ...
    def get_event_bus_config(cls) -> EventBusConfig:
        ...
        return EventBusConfig(
            ...
            exchange_name=os.environ.get('RABBITMQ_EXCHANGE', 'domain_management_service_events')
        )
...
class DevelopmentConfig(BaseConfig):
    ...
    def get_database_config(cls) -> DatabaseConfig:
        ...
        return DatabaseConfig(
            ...
            database=os.environ.get('DB_NAME', 'domain_management_dev'),
            pool_size=5,
            max_overflow=10,
            pool_timeout=20
        )
...
def setup_logging(config: BaseConfig) -> None:
    """Setup logging configuration for domain-management-service."""
    import logging
