"""
Configuration module for Monitoring Service.

This module provides environment-specific configuration classes that handle
system monitoring and health checks, database connections, event bus configuration,
...
class EventBusConfig:
    ...
    password: str
    virtual_host: str = "/"
    exchange_name: str = "monitoring_service_events"
...
class BaseConfig:
    """Base configuration class for Monitoring Service."""
    
    # Flask Settings
    SECRET_KEY: str = os.environ.get('SECRET_KEY', 'dev-monitoring-service-secret-key')
    DEBUG: bool = False
    TESTING: bool = False
    ...
    def get_event_bus_config(cls) -> EventBusConfig:
        ...
        return EventBusConfig(
            ...
            exchange_name=os.environ.get('RABBITMQ_EXCHANGE', 'monitoring_service_events')
        )
...
class DevelopmentConfig(BaseConfig):
    ...
    def get_database_config(cls) -> DatabaseConfig:
        ...
        return DatabaseConfig(
            ...
            database=os.environ.get('DB_NAME', 'monitoring_dev'),
            pool_size=5,
            max_overflow=10,
            pool_timeout=20
        )
...
def setup_logging(config: BaseConfig) -> None:
    """Setup logging configuration for monitoring-service."""
    import logging
