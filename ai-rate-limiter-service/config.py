"""
Configuration module for Ai Rate Limiter Service.

This module provides environment-specific configuration classes that handle
ai api rate limiting and quota management, database connections, event bus configuration,
...
class EventBusConfig:
    ...
    password: str
    virtual_host: str = "/"
    exchange_name: str = "ai_rate_limiter_service_events"
...
class BaseConfig:
    """Base configuration class for Ai Rate Limiter Service."""
    
    # Flask Settings
    SECRET_KEY: str = os.environ.get('SECRET_KEY', 'dev-ai-rate-limiter-service-secret-key')
    DEBUG: bool = False
    TESTING: bool = False
    ...
    SERVICE_NAME: str = "ai-rate-limiter-service"
    ...
    def get_event_bus_config(cls) -> EventBusConfig:
        ...
        return EventBusConfig(
            ...
            exchange_name=os.environ.get('RABBITMQ_EXCHANGE', 'ai_rate_limiter_service_events')
        )
...
class DevelopmentConfig(BaseConfig):
    ...
    def get_database_config(cls) -> DatabaseConfig:
        ...
        return DatabaseConfig(
            ...
            database=os.environ.get('DB_NAME', 'ai_rate_limiter_dev'),
            pool_size=5,
            max_overflow=10,
            pool_timeout=20
        )
...
def setup_logging(config: BaseConfig) -> None:
    """Setup logging configuration for ai-rate-limiter-service."""
    import logging
