...
The Notification Service is a microservice that handles handles all types of notifications. It's part of an event-driven architecture using Flask, PostgreSQL, and RabbitMQ.
...
export DB_NAME=notifications_dev
...
- **Notification**: [Description needed]
- **NotificationTemplate**: [Description needed]
- **NotificationChannel**: [Description needed]
...
docker build -t notification-service:latest --target production .
