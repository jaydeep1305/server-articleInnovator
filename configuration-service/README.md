...
The Configuration Service is a microservice that handles global configuration management. It's part of an event-driven architecture using Flask, PostgreSQL, and RabbitMQ.
...
export DB_NAME=configuration_dev
...
- **ConfigurationItem**: [Description needed]
- **Environment**: [Description needed]
- **Secret**: [Description needed]
...
docker build -t configuration-service:latest --target production .
...
### Logging
- Logs are written to `logs/configuration-service.log`
