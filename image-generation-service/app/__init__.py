"""
Image Generation Service - Flask Application Factory
...
def register_middleware(app: Flask) -> None:
    ...
    def add_security_headers(response):
        ...
        response.headers['X-Service'] = app.config.get('SERVICE_NAME', 'image-generation-service')
...
def setup_app_logging(app: Flask) -> None:
    ...
    if not app.debug and not app.testing:
        ...
        file_handler = RotatingFileHandler(
            'logs/image-generation-service.log',
        ...
        app.logger.info(f'Image Generation Service startup')
