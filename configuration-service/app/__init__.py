"""
Configuration Service - Flask Application Factory
...
def register_middleware(app: Flask) -> None:
    ...
    def add_security_headers(response):
        ...
        response.headers['X-Service'] = app.config.get('SERVICE_NAME', 'configuration-service')
...
def setup_app_logging(app: Flask) -> None:
    ...
    if not app.debug and not app.testing:
        ...
        app.logger.info(f'Configuration Service startup')
