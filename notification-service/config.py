...
handles all types of notifications, database connections, event bus configuration,
...
class EventBusConfig:
    ...
    password: str
    virtual_host: str = "/"
    exchange_name: str = "notification_service_events"
...
class BaseConfig:
    """Base configuration class for Notification Service."""
    
    # Flask Settings
    SECRET_KEY: str = os.environ.get('SECRET_KEY', 'dev-notification-service-secret-key')
    DEBUG: bool = False
    TESTING: bool = False
    ...
    def get_event_bus_config(cls) -> EventBusConfig:
        ...
        return EventBusConfig(
            ...
            exchange_name=os.environ.get('RABBITMQ_EXCHANGE', 'notification_service_events')
        )
...
class DevelopmentConfig(BaseConfig):
    ...
    def get_database_config(cls) -> DatabaseConfig:
        ...
        return DatabaseConfig(
            ...
            database=os.environ.get('DB_NAME', 'notifications_dev'),
            pool_size=5,
            max_overflow=10,
            pool_timeout=20
        )
...
def setup_logging(config: BaseConfig) -> None:
    """Setup logging configuration for notification-service."""
    import logging
